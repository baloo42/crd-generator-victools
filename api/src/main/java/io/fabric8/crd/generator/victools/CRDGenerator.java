...
public class CRDGenerator implements CRDGeneratorApi {
  ...
  private static final EnumSet<CRDGeneratorSchemaOption> DEFAULT_OPTIONS_ENABLED = EnumSet.of(
      CRDGeneratorSchemaOption.OWN_ANNOTATIONS,
      CRDGeneratorSchemaOption.FKC_ANNOTATIONS);
  ...
  public CRDGenerator() {
    enabledOptions.addAll(DEFAULT_OPTIONS_ENABLED);
  }
