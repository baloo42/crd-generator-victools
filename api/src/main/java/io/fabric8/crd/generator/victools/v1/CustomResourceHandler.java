...
import io.fabric8.crd.generator.victools.schema.fkc.FkcAdditionalPrinterColumnProvider;
...
class CustomResourceHandler extends AbstractCustomResourceHandler {
  ...
  public void handle(
    ...
    if (generatorContext.isEnabled(CRDGeneratorSchemaOption.FKC_ANNOTATIONS)) {
      printerColumnProviders.add(new FkcAdditionalPrinterColumnProvider(crInfo));
