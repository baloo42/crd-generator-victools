...
```
crd-gen [-hVv] [--force-index] [--force-scan] [--implicit-preserve-unknown-fields] [--no-parallel] [--schema]
        [--filename-format=<filenameFormat>] [--header=<header>] [-o=<outputDirectory>]
        [--schema-filename-format=<schemaFilenameFormat>] [--annotation=<<key>=<value>>]... [-cp=<classpathElement>]...
        [--exclude-package=<package>]... [--include-package=<package>]... [--label=<<key>=<value>>]... <source>...

Description:

Fabric8 CRD-Generator (victools/jsonschema)
Generate Custom Resource Definitions (CRD) for Kubernetes from Java classes.
...
Options:
  -o, --output-dir=<outputDirectory>
      ...
      --filename-format=<filenameFormat>
                          The format to create the filename for the CRD files.
                            Default: {{crdName}}-{{crdSpecVersion}}.yml
      --schema            Enables emitting JSON-Schemas in addition to the CRDs.
      --schema-filename-format=<schemaFilenameFormat>
                          The format to create the filename for the JSON-Schema files.
                            Default: {{resourceGroup}}/{{resourceKind}}_{{resourceAPIVersion}}.json
      ...
      --header=<header>   The header content.
                          If not empty, this text will be added as comment on top of each CRD file. Multiline texts are
                            supported and will be handled accordingly.
                            Default: Generated by Fabric8 CRDGenerator, manual edits might get overwritten!
      --label=<<key>=<value>>
                          Additional label for all CRDs. Useful to add e.g. vcs or build details.
      --annotation=<<key>=<value>>
                          Additional annotation for all CRDs. Useful to add e.g. vcs or build details.
